...
namespace hades
{
  ...
  void Editor::scene(EntityManager &entityManager, ComponentManager &componentManager)
  {
...

    {
      ...
      // Render toolbar controls as icon-only buttons.
      ...
      if (ImGui::SmallButton(ICON_FA_ARROWS_UP_DOWN_LEFT_RIGHT "##SceneGizmoMove"))
      {
      ...
      if (ImGui::SmallButton(ICON_FA_ARROWS_ROTATE "##SceneGizmoRotate"))
      {
      ...
      if (ImGui::SmallButton(ICON_FA_UP_RIGHT_AND_DOWN_LEFT_FROM_CENTER "##SceneGizmoScale"))
      {
      ...
      ImGui::SameLine();
      const char *drawModeIcon = sceneDrawModelMeshes_ ? ICON_FA_CUBE : ICON_FA_BORDER_ALL;
      if (ImGui::SmallButton((std::string(drawModeIcon) + "##SceneDrawMode").c_str()))
      {
