...
#if !defined(BGFX_CONFIG_RENDERER_AGC) && !defined(BGFX_CONFIG_RENDERER_DIRECT3D11) && !defined(BGFX_CONFIG_RENDERER_DIRECT3D12) && !defined(BGFX_CONFIG_RENDERER_GNM) && !defined(BGFX_CONFIG_RENDERER_METAL) && !defined(BGFX_CONFIG_RENDERER_NVN) && !defined(BGFX_CONFIG_RENDERER_OPENGL) && !defined(BGFX_CONFIG_RENDERER_OPENGLES) && !defined(BGFX_CONFIG_RENDERER_VULKAN)

#ifndef BGFX_CONFIG_RENDERER_AGC
#define BGFX_CONFIG_RENDERER_AGC (0 || BX_PLATFORM_PS5 \
									  ? 1              \
									  : 0)
#endif // BGFX_CONFIG_RENDERER_AGC

#ifndef BGFX_CONFIG_RENDERER_DIRECT3D11
#define BGFX_CONFIG_RENDERER_DIRECT3D11 (0 || BX_PLATFORM_LINUX || BX_PLATFORM_WINDOWS || BX_PLATFORM_WINRT || BX_PLATFORM_XBOXONE \
											 ? 1                                                                                   \
											 : 0)
#endif // BGFX_CONFIG_RENDERER_DIRECT3D11

#ifndef BGFX_CONFIG_RENDERER_DIRECT3D12
#define BGFX_CONFIG_RENDERER_DIRECT3D12 (0 || BX_PLATFORM_LINUX || BX_PLATFORM_WINDOWS || BX_PLATFORM_WINRT || BX_PLATFORM_XBOXONE \
											 ? 1                                                                                   \
											 : 0)
#endif // BGFX_CONFIG_RENDERER_DIRECT3D12

#ifndef BGFX_CONFIG_RENDERER_GNM
#define BGFX_CONFIG_RENDERER_GNM (0 || BX_PLATFORM_PS4 \
									  ? 1              \
									  : 0)
#endif // BGFX_CONFIG_RENDERER_GNM

#ifndef BGFX_CONFIG_RENDERER_METAL
#define BGFX_CONFIG_RENDERER_METAL (0 || BX_PLATFORM_IOS || BX_PLATFORM_OSX || BX_PLATFORM_VISIONOS \
										? 1                                                         \
										: 0)
#endif // BGFX_CONFIG_RENDERER_METAL

#ifndef BGFX_CONFIG_RENDERER_NVN
#define BGFX_CONFIG_RENDERER_NVN (0 || BX_PLATFORM_NX \
									  ? 1             \
									  : 0)
...
#define BGFX_CONFIG_RENDERER_OPENGL (0 || BX_PLATFORM_LINUX || BX_PLATFORM_WINDOWS \
										 ? BGFX_CONFIG_RENDERER_OPENGL_MIN_VERSION \
										 : 0)
#endif // BGFX_CONFIG_RENDERER_OPENGL

#ifndef BGFX_CONFIG_RENDERER_OPENGLES_MIN_VERSION
#define BGFX_CONFIG_RENDERER_OPENGLES_MIN_VERSION (0 || BX_PLATFORM_ANDROID \
													   ? 30                 \
													   : 1)
#endif // BGFX_CONFIG_RENDERER_OPENGLES_MIN_VERSION

#ifndef BGFX_CONFIG_RENDERER_OPENGLES
#define BGFX_CONFIG_RENDERER_OPENGLES (0 || BX_PLATFORM_ANDROID || BX_PLATFORM_EMSCRIPTEN || BX_PLATFORM_RPI || BX_PLATFORM_NX \
										   ? BGFX_CONFIG_RENDERER_OPENGLES_MIN_VERSION                                         \
										   : 0)
#endif // BGFX_CONFIG_RENDERER_OPENGLES

#ifndef BGFX_CONFIG_RENDERER_VULKAN
#define BGFX_CONFIG_RENDERER_VULKAN (0 || BX_PLATFORM_ANDROID || BX_PLATFORM_LINUX || BX_PLATFORM_WINDOWS || BX_PLATFORM_NX || BX_PLATFORM_OSX \
										 ? 1                                                                                                   \
										 : 0)
